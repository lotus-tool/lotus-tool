 ...
 */
public class ProjectDialogsDS extends Plugin{
    ...
    public boolean save(ProjectDS project, ProjectDSSerializer serializer, String title, String extensionDescription, String extension/*, boolean close*/) {
         return realSave(project, serializer, false, true, title, extensionDescription, extension/*, close*/);
    }
    
    public ProjectDS open(ProjectDSSerializer serializer, String title, String extensionDescription, String extension) {
    ...
    private boolean realSave(ProjectDS project, ProjectDSSerializer serializer, boolean forceShowDialog, boolean cacheFileName, String title, String extensionDescription, String extension) {
        if(project == null){

...
public class InitializeAndRangeVariablesController {
    ...
    private final ProjectExplorerPluginDS mProjectExplorerDS;
    ...
    public InitializeAndRangeVariablesController(Component component, ProjectExplorerPluginDS mProjectExplorerDS) {
    ...
    private EventHandler<ActionEvent> runAction() {
        return event -> {
            ...
            ProjectDS projectDS = searchCurrentProjectDS();

            if(projectDS!=null){
                projectDS.addComponentFragmentLTS(traceComponent);
            }else {
                //todo show exception
            }
    ...
    private ProjectDS searchCurrentProjectDS() {
        for(ProjectDS projectDS : mProjectExplorerDS.getAllProjectsDS()){
            if(projectDS.getLTS_Composed().equals(component));
           return projectDS;
        }
        return null;
    }

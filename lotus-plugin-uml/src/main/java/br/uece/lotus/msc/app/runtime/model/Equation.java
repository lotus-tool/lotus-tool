package br.uece.lotus.msc.app.runtime.model;
...
public class Equation {
    ...
    private HmscBlock firstHMSCHmscBlock;
    private HmscBlock secondHMSCHmscBlock;
    ...
    public Equation setFirstHMSCHmscBlock(HmscBlock firstHMSCHmscBlock) {
        this.firstHMSCHmscBlock = firstHMSCHmscBlock;
        this.firstHMSCProperty.set(firstHMSCHmscBlock.getLabel());
        return this;
    }
    ...
    public Equation setSecondHMSCHmscBlock(HmscBlock secondHMSCHmscBlock) {
        this.secondHMSCHmscBlock = secondHMSCHmscBlock;
        this.secondHMSCProperty.set(secondHMSCHmscBlock.getLabel());
        return this;
    }
    ...
    public HmscBlock getFirstHMSCHmscBlock() {
        return firstHMSCHmscBlock;
    }

    public HmscBlock getSecondHMSCHmscBlock() {
        return secondHMSCHmscBlock;
    }

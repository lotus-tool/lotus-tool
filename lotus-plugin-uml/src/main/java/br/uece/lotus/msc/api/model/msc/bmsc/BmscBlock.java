 ...
 * @author Created by Lucas Vieira Alves on 11/12/15.
 */
public class BmscBlock{
    /**
     * O {@link BmscBlock#mTextStyleBold} é alguma coisa
     */
    ...
    private final BmscComponent bmscComponent;
    private int mID;
    ...
    BmscBlock(BmscComponent bmscComponent) {
        this.bmscComponent = bmscComponent;}

    /**
     * Retorna o getBmscComponent
     * @return
     */
    public BmscComponent getBmscComponent(){return this.bmscComponent;}
    ...
    public interface Listener{
        void onChange( BmscBlock diagrama);
    }
    ...
    public TransitionMSC getTransitionTo(BmscBlock ds) {
    ...
    public List<TransitionMSC> getTransitionsTo(BmscBlock ds) {
...
//        mLayoutY = model.mLayoutY;
    ...
    public boolean equals(Object obj) {
        ...
        final BmscBlock other = (BmscBlock) obj;
   ...
   /* public Iterable<Transition> getIncomingTransitions() {
    ...
    public Iterable<Transition> getOutgoingTransitionList() {

   ...
   /* private DoubleBinding buildLayoutXProperty(Region origem) {
    ...
    static class TransicaoEmArcoMSC extends Region {
        ...
        private int quantidadeFilhosHmsc(TransitionMSC mTransition) {
            ...
            try{
                 listaT = ((GenericElement)mTransition.getSource()).getTransitionsTo(((GenericElement)mTransition.getDestiny()));
            } catch(ClassCastException e){
                listaT = ((GenericElementView)mTransition.getSource()).getGenericElement().getTransitionsTo(((GenericElementView)mTransition.getDestiny()).getGenericElement());
            }

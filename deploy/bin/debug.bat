...
java -Xdebug -Xnoagent -Djava.compiler=NONE -Xrunjdwp:transport=dt_socket,server=y,suspend=y,address=5005 -Dlotus.extensions.path=%LOTUS_EXT_DIR% -classpath "%CP%" br.uece.seed.app.Startup %*
rem exit
pause

...
#LOTUS_JAVA_DEBUG="-Xdebug -Xrunjdwp:transport=dt_socket,address=127.0.0.1:8000"
LOTUS_JAVA_DEBUG="-Xdebug -Xnoagent -Djava.compiler=NONE -Xrunjdwp:transport=dt_socket,server=y,suspend=y,address=5005"
